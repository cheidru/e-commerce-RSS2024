const asyncMember = [
  {
    firstName: 'Anzhelika',
    avatar: '../../assets/img/images/asinc-biker-girl.jpg',
    photo: '../../assets/img/images/Lika-photo.jpg',
  ...
  {
    firstName: 'Sergey',
    avatar: '../../assets/img/images/asinc-rocket.jpg',
    photo: '../../assets/img/images/sergey-photo.jpg',
    role: 'FrontEnd Developer',
    title: 'The Fixer',
    shortBio: '',
  ...
  {
    firstName: 'Igor',
    avatar: '../../assets/img/images/asinc-baby.jpg',
    photo: '../../assets/img/images/igor-picture.jpg',
    role: 'FrontEnd Developer',
    title: 'The Scholar',
    shortBio: '',
